...
public class W15_04_method_findMaxMin {
    ...
    static int findMax(int a, int b) {
        ...
        return a > b ? a : b; // ใช้ในเงื่อนไข ternary operator
    }
    ...
    public static void main(String[] args) {
        ...
        // 1) Method สำหรับหาค่ามากที่สุด
        System.out.println("ค่ามากสุดคือ  [10, 20] " + findMax(10, 20));

        // 2) Method สำหรับหาค่าน้อยที่สุด
        System.out.println("ค่าน้อยสุดคือ [10, 20] " + findMin(10, 20));
        // 3) Method สำหรับหาค่ามากที่สุด โดยรับค่า 3 ตัว
        System.out.println("ค่ามากสุดคือ [10, 20, 30] " + findMax(10, 20, 30));
        // 4) Method สำหรับหาค่าน้อยที่สุด โดยรับค่าเป็น array
        int[] numbers = {10, 20, 30, 9, 8};
        //array(numbers);
